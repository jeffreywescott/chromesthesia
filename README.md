...
2. **Pitch extraction**: FFT bins are mapped to pitch classes (C–B) via equal temperament. Each frame, amplitudes are averaged per pitch class, normalized relative to the loudest note, and shaped with a contrast curve (^2) to suppress overtones.
